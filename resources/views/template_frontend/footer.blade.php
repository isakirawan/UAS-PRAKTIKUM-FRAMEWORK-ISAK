		...
		<div class="social-links-warp">
			<div class="container">
				<div class="social-links">
					...
					<a target="_blank" href="#" class="whatsapp"><i class="fa fa-whatsapp"></i><span>Whatsapp</span></a>
					<a target="_blank" href="#" class="youtube"><i class="fa fa-youtube"></i><span>Youtube</span></a>
				</div>
				<p class="text-white text-center mt-5">Copyright &copy; @if(date('Y') == '2022') {{ date('Y') }} @else 2022 - {{ date('Y') }} @endif All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://github.com/adhiariyadi/" target="_blank">Isak Irawan</a>.</p>
			</div>
		</div>
	</section>
	<!-- Footer section end -->
