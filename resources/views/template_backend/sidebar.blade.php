  ...
  <nav id="sidebar">
    <div class="sidebar-header">
      <a href="{{ route('profil', Auth::user()->id) }}">
        ...
        @else
          <img class="rounded-circle img-thumbnail" src="{{ asset('admin/img/message/1.jpg') }}" alt="" style="width: 60px;" />
        @endif
      </a>
    ...
    <div class="left-custom-menu-adp-wrap">
      <ul class="nav navbar-nav left-sidebar-menu-pro">
        <li class="nav-item"><a href="{{ route('adminku.index') }}" class="nav-link dropdown-toggle"><i class="fa big-icon fa-home"></i> <span class="mini-dn">Home</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a></li>
        <li class="nav-item">
