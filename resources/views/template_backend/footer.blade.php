    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="footer-copy-right">
          <p>Copyright &copy; @if(date('Y') == '2022') {{ date('Y') }} @else 2022 - {{ date('Y') }} @endif All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="/" target="_blank">Isak Irawan</a>.</p>
        </div>
      </div>
    </div>
  </div>
