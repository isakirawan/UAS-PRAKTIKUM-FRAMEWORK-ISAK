...
Route::middleware(['auth'])->group(function () {
  ...
  Route::middleware(['role'])->group(function () {
    ...
    Route::resource('adminku/merek', 'MerekController');
    Route::resource('adminku/order', 'OrderController');
    Route::get('adminku/order/tampil_cancel', 'OrderController@tampil_cancel')->name('order.tampil_cancel');
    Route::get('adminku/order/tampil_bayar', 'OrderController@tampil_bayar')->name('order.tampil_bayar');
    Route::get('adminku/order/tampil_pending', 'OrderController@tampil_pending')->name('order.tampil_pending');
    Route::resource('adminku/akun', 'AkunController');
    Route::resource('adminku/mobil', 'MobilController');
    Route::get('adminku/create/mobil', 'MobilController@create')->name('create.mobil');
    Route::get('adminku/mobil/tampil_hapus', 'MobilController@tampil_hapus')->name('mobil.tampil_hapus');
    Route::get('adminku/mobil/restore/{id}', 'MobilController@restore')->name('mobil.restore');
    Route::delete('adminku/mobil/kill/{id}', 'MobilController@kill')->name('mobil.kill');
    
    Route::resource('/adminku', 'DashboardController');
  });
